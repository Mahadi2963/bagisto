describe('Delete Customer Review', () => {
    it('should delete customer review successfully through the admin panel', () => {
        ...
        cy.get("body > div:nth-child(1) > div:nth-child(5) > div:nth-child(2) > div:nth-child(3) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(4) > a:nth-child(1) > span:nth-child(1)").click()
